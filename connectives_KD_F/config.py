...
class Config(object):
    def __init__(self, classnum=4, splitting=2):
        self.i2sense = [
        ...
        self.wordvec_path = '~/IDR/emb_data/GoogleNews-vectors-negative300.bin.gz'
        # self.wordvec_path = 'D:/code/IDR/emb_data/GoogleNews-vectors-negative300.bin.gz'
        ...
        # elmo
        self.need_elmo = True
        self.elmo_options = '~/IDR/emb_data/ELMo/elmo_2x4096_512_2048cnn_2xhighway_options.json'
        self.elmo_weights = '~/IDR/emb_data/ELMo/elmo_2x4096_512_2048cnn_2xhighway_weights.hdf5'
        # self.elmo_options = 'D:/code/IDR/emb_data/ELMo/elmo_2x4096_512_2048cnn_2xhighway_options.json'
        # self.elmo_weights = 'D:/code/IDR/emb_data/ELMo/elmo_2x4096_512_2048cnn_2xhighway_weights.hdf5'
